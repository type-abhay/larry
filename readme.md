...
# Lyric Embedder README

<table>
  <tr>
    <td><img src="icon.ico" width="120" alt="App icon"/></td>
    <td><h1>Lyric Embedder</h1></td>
  </tr>
</table>

[![Get it on GitHub](https://img.shields.io/badge/Get%20it%20on-GitHub-blue?style=for-the-badge&logo=github)](https://github.com/YOUR_USERNAME/YOUR_REPO_NAME/releases)

A high-performance, command-line utility built in Go for managing audio metadata. **Lyric Embedder** allows you to search, view, and embed both synced (LRC) and plain text lyrics directly into your music files. It supports **MP3**, **FLAC**, and **M4A** formats using native bit-stream manipulation.
...
If you want to compile the project yourself (and include the custom icon), follow these steps:
